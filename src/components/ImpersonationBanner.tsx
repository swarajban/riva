...
export function ImpersonationBanner({ impersonatedEmail }: ImpersonationBannerProps): React.ReactElement {
  ...
  return (
    <div className="bg-taupe text-white px-4 py-2">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button
          ...
          disabled={stopping}
          className="px-3 py-1 bg-white text-taupe rounded-md text-sm font-medium hover:bg-cream disabled:opacity-50 transition-all duration-200"
        >
